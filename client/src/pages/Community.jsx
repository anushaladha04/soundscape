      ...
      <main className="min-h-screen bg-[#0f0f0f] text-white">
        <div className="bg-[#1a1a1a]/30 border-b border-[#2a2a2a]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <button
              onClick={fetchPosts}
              className="mt-4 px-4 py-2 bg-[#FF6B35] text-white rounded-md hover:bg-[#FF6B35]/90"
            >
              Try Again
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {posts.map((post) => {
              ...
              return (
                <div
                  key={post._id}
                  className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg overflow-hidden hover:border-[#FF6B35] transition-colors group"
                >
                  <div className="p-6">
                    {/* Genre Tag */}
                    <p className="text-xs text-[#FF6B35] font-semibold mb-2 uppercase tracking-wide">
                      {post.genre}
                    </p>
